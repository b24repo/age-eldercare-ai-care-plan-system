...
const ProcessingStep = ({ step, index, active, completed }) => {
  ...
  return (
    <div className={`flex items-center space-x-3 p-4 rounded-lg ${
      ...
      {active && <div className="font-medium text-blue-600">Processing...</div>}
    ...
    <div className="bg-white border rounded-lg shadow-md">
      ...
      <div className="p-6 pt-3">
        <div className="grid grid-cols-2 gap-3 md:grid-cols-7">
          ...
          <div className="p-3 text-center border-2 rounded-lg bg-emerald-50 border-emerald-200">
            <div className="text-lg font-bold text-emerald-600">{scores.clinicalSafety}</div>
            <div className="text-xs text-gray-600">Safety</div>
          </div>
          <div className="p-3 text-center border-2 border-purple-200 rounded-lg bg-purple-50">
          ...
          <div className="p-3 text-center border-2 border-blue-200 rounded-lg bg-blue-50">
...
Generated by: Senior-Level AI Care Plan System`;
  ...
  return (
    <div className="max-w-6xl min-h-screen p-6 mx-auto bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      {activeTab === 'input' && (
        <div className="space-y-6">
          <div className="bg-white border rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 gap-6 p-6 pt-3 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">Age & Living Situation</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">Medical History</label>
                  <textarea
              ...
              <div className="space-y-4">
                <div>
                  <label className="block mb-1 text-sm font-medium">Current Concerns</label>
                  <textarea
                ...
                <div>
                  <label className="block mb-1 text-sm font-medium">Family Input</label>
                  <textarea
          ...
          <div className="text-center">
            <button 
              ...
              className="inline-flex items-center justify-center h-10 px-8 py-3 text-lg font-medium text-white transition-colors bg-blue-600 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-blue-700"
            ...
            <div className="p-6 pt-3">
              ...
              <div className="space-y-2 overflow-y-auto max-h-64">
                {processingActivities.map((activity, index) => (
                  <div key={index} className="flex items-start p-2 space-x-3 rounded bg-gray-50">
                    <div className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-gray-100 text-gray-800">
                      {activity.timestamp}
                    </div>
                    <div 
                    ...
                    <span className="flex-1 text-sm">{activity.activity}</span>
                  </div>
                ))}
              </div>
      ...
      {activeTab === 'results' && finalPlan && (
        <div className="space-y-6">
          <div className="bg-white border rounded-lg shadow-md">
            <div className="p-6 pb-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <div className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-green-100 text-green-800">
                    Score: {qualityScores?.['Overall Effectiveness']}/5.0
                  </div>
                  <button 
                    onClick={exportCarePlan}
                    className="inline-flex items-center justify-center h-8 px-3 text-sm font-medium text-gray-700 transition-colors bg-white border border-gray-300 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-gray-50"
                  >
            ...
            <div className="p-6 pt-3">
              <div className="p-6 overflow-y-auto bg-white border rounded-lg max-h-96">
                <pre className="text-sm whitespace-pre-wrap">{finalPlan?.content || ""}</pre>
              </div>
            </div>
          </div>
